...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield mongoose_1.default.connect(`mongodb://${mongoDbContainerName}:27017`, {
    ...
    app.get('/add-student', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { age, name } = req.query;
        yield StudentModel.create({ age, name });
